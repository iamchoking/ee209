...
CorrectnessTest6() {
	...
	result = 0;
	printf("------------------------------------------------------\n" \
		   "  Correctness Test 6 [CUSTOM]:\n" \
		   "  Register / Unregister Including Array Expansion\n"\
		   "------------------------------------------------------\n");
	...
	for(int i = 0;i<max_num;i++){
		...
		sprintf(id, "id%d",i);
		result += TestRegisterCustomer(d, id,name,i+1,0);
	}
	printf("\n\n-----------------------------------------------\n\n");
	...
	for(int i = 0;i<max_num;i+=2){
		sprintf(id,"id%d",i);
		result+=TestUnregisterCustomerByID(d,id,(i%6==0?-1:0));
	}
	printf("\n\n-----------------------------------------------\n\n");
	printDB(d);
	...
	for(int i = 0;i<max_num;i++){
		...
		sprintf(name, "name%d",i);
		sprintf(id, "id%d",i);
		result += TestRegisterCustomer(d, id,name,i+1,((i%2==0)||(i%3==0)?0:-1));
	}
	printf("\n\n-----------------------------------------------\n\n");
	printDB(d);
...
CorrectnessTest7() {
	...
	result = 0;
	printf("------------------------------------------------------\n" \
		   "  Correctness Test 7: [CUSTOM]go away i want to sleep\n" \
		   "------------------------------------------------------\n");
	...
	result += TestRegisterCustomer(d, "id0-1", "name0-1", 10, 0);
	result += TestRegisterCustomer(d, "id0-1", "name0-1", 10, -1);

	result += TestRegisterCustomer(d, "id0-2", "name0-2", 10, 0);
	result += TestRegisterCustomer(d, "id0-3", "name0-2", 10, -1);
	result += TestRegisterCustomer(d, "id0-2", "name0-3", 10, -1);

	result += TestRegisterCustomer(d, "id0-3", "name0-3", 10, 0);
	result += TestRegisterCustomer(d, "id0-4", "name0-4", 10, 0);
	result += TestRegisterCustomer(d, "id0-5", "name0-5", 10, 0);
	result += TestRegisterCustomer(d, "id0-6", "name0-6", 10, 0);
	result += TestRegisterCustomer(d, "id0-7", "name0-7", 10, 0);

	result += TestRegisterCustomer(d, "ID1-A", "NAME1-I", 10, 0);
	result += TestRegisterCustomer(d, "ID1-B", "NAME1-II", 10, 0);
	result += TestRegisterCustomer(d, "ID1-C", "NAME1-III", 10, 0);
	result += TestRegisterCustomer(d, "ID1-D", "NAME1-IV", 10, 0);
	result += TestRegisterCustomer(d, "ID1-E", "NAME1-V", 10, 0);
	result += TestRegisterCustomer(d, "ID1-F", "NAME1-VI", 10, 0);
	result += TestRegisterCustomer(d, "ID1-G", "NAME1-VII", 10, 0);

	result += TestRegisterCustomer(d, "ID2-A8", "NAME2-I", 10, 0);
	result += TestRegisterCustomer(d, "ID2-B8", "NAME2-II", 10, 0);
	result += TestRegisterCustomer(d, "ID2-C8", "NAME2-III", 10, 0);
	result += TestRegisterCustomer(d, "ID2-D8", "NAME2-IV", 10, 0);
	result += TestRegisterCustomer(d, "ID2-E8", "NAME2-V", 10, 0);
	result += TestRegisterCustomer(d, "ID2-F8", "NAME2-VI", 10, 0);
	result += TestRegisterCustomer(d, "ID2-G8", "NAME2-VII", 10, 0);

	printDB(d);

	result += TestUnregisterCustomerByID(d,"id0-1",0);
	result += TestUnregisterCustomerByID(d,"id0-2",0);
	result += TestUnregisterCustomerByID(d,"id0-2",-1);
	result += TestUnregisterCustomerByID(d,"ID1-B",0);
	result += TestUnregisterCustomerByID(d,"ID1-F",0);
	result += TestUnregisterCustomerByID(d,"ID1-F",-1);
...
main(int argc, const char *argv[])
{
	...
	/* ./testclient -c case : run the certain correctness test*/
		...
		if (atoi(argv[2]) == 1)
			...
			CorrectnessTest5();
		//CUSTOM TESTS mapped here (without damaging main testclient)
